...
knitr::include_graphics(here::here("man", "figures", "Sliced_pas_tree.png"))
```
...
```
```{r, echo = FALSE, fig.align='center'}
knitr::include_graphics(here::here("man", "figures", "OneTree_DR.png"))
```
...
```
```{r, echo = FALSE, fig.align='center'}
knitr::include_graphics(here::here("man", "figures", "OneTree_sensitivity.png"))
```
...
```
```{r, echo = FALSE, fig.align='center'}
knitr::include_graphics(here::here("man", "figures", "OneTree_turn.png"))
```
...
```
```{r, echo = FALSE, fig.align='center'}
knitr::include_graphics(here::here("man", "figures", "OneTree_nest.png"))
```
...
```
```{r, echo = FALSE, fig.align='center'}
knitr::include_graphics(here::here("man", "figures", "AllTrees_DR.png"))
```
...
```
```{r, echo = FALSE, fig.align='center'}
knitr::include_graphics(here::here("man", "figures", "AllTrees_turn.png"))
```
...
```
```{r, echo = FALSE, fig.align='center'}
knitr::include_graphics(here::here("man", "figures", "AllTrees_nest.png"))
```
