...
knitr::include_graphics("C:/Matheus/Facul/2_Masters/treesliceR/man/figures/Sliced_pas_tree.png")
```
...
```
```{r, echo = FALSE, fig.align='center'}
knitr::include_graphics("C:/Matheus/Facul/2_Masters/treesliceR/man/figures/OneTree_DR.png")
```
...
```
```{r, echo = FALSE, fig.align='center'}
knitr::include_graphics("C:/Matheus/Facul/2_Masters/treesliceR/man/figures/OneTree_sensitivity.png")
```
...
```
```{r, echo = FALSE, fig.align='center'}
knitr::include_graphics("C:/Matheus/Facul/2_Masters/treesliceR/man/figures/OneTree_turn.png")
```
...
```
```{r, echo = FALSE, fig.align='center'}
knitr::include_graphics("C:/Matheus/Facul/2_Masters/treesliceR/man/figures/OneTree_nest.png")
```

# Case study using a multiple (100) passeriformes tree
...
```
```{r, echo = FALSE, fig.align='center'}
knitr::include_graphics("C:/Matheus/Facul/2_Masters/treesliceR/man/figures/AllTrees_DR.png")
```
...
First we'll run the analysis for the **TURNOVER**. Pay attention that we are setting to execute the function under parallel programing, being this code executed under 5 cores. Before run, you *must* confirm if the number of cores are supported by your machine. Anyway, the following function can take some long minutes to end:
```{r, eval = FALSE}
...
Now, we capture the mean of each parameter and store then within a new data.fram
```{r, eval = FALSE}
...
```
```{r, echo = FALSE, fig.align='center'}
knitr::include_graphics("C:/Matheus/Facul/2_Masters/treesliceR/man/figures/AllTrees_turn.png")
```

Now, we'll run the analysis for the **NESTEDNESS**:
```{r, eval = FALSE}
...
```
```{r, echo = FALSE, fig.align='center'}
knitr::include_graphics("C:/Matheus/Facul/2_Masters/treesliceR/man/figures/AllTrees_nest.png")
```
